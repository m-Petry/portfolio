...
function WorkExperience({ experiences }: Props) {
  return (
    <motion.div className="top-40 mt-12 flex relative overflow-hidden flex-col text-left md:flex-row max-w-full px-10 justify-evenly mx-auto items-center ">
      ...
      <div className="mt-10 w-full max-w-5xl flex space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80">
